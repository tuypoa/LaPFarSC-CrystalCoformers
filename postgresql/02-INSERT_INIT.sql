...
INSERT INTO tarefa(codigo,nome,descricao,ordem,manual,javaclass,software,etapa_codigo,tarefa_codigo) values 
  (2,'Otimizar geometria','Minimização de energia utilizando método de mecânica molecular com campo de força MMFF94.',20,false,'lapfarsc.cocrystal.tarefa.OtimizarGeometriaMMFF94','Molconverter Marvin Suite',1,null),
  (3,'Refinar geometria','Utilizando métodos de mecânica quântica semi-empíricos PM6 e PM7.',30,false,'lapfarsc.cocrystal.tarefa.RefinarGeometria','MOPAC2016',1,2),
  (5,'Definir co-formadores',null,40,true,'lapfarsc.cocrystal.tarefa.DefinirCoformadores',null,1,2);

INSERT INTO tarefa(codigo,nome,descricao,ordem,manual,javaclass,software,etapa_codigo,tarefa_codigo) values 
  (6,'Gerar confôrmeros do fármaco','Utilizar o programa Mercury na opção CSD-Materials.',10,true,null,'CCDC Mercury',2,5),
  (7,'Complementariedade molecular','Utilizar o programa Mercury na opção CSD-Materials > Co-Crystal Design.',20,true,null,'CCDC Mercury',2,6),
  (8,'Compilar dados',null,30,false,'lapfarsc.cocrystal.tarefa.CompilarAnaliseQualitativa','Local script',2,7);
  
INSERT INTO tarefa(codigo,nome,descricao,ordem,manual,javaclass,software,etapa_codigo,tarefa_codigo) values 
  (9 ,'Docking molecular entre fármaco e co-formadores',null,10,false,'lapfarsc.cocrystal.tarefa.DockingQuantitativo','Molegro Virtual Docker',3,5),
  (10,'Compilar dados',null,20,false,'lapfarsc.cocrystal.tarefa.CompilarAnaliseQuantitativa','Local script',3,9);
  
INSERT INTO tarefa(codigo,nome,descricao,ordem,manual,javaclass,software,etapa_codigo,tarefa_codigo) values 
  (11 ,'Fármaco e co-formadores',null,10,true,'lapfarsc.cocrystal.tarefa.CompilarRankingTriagem','Local script',4,10);
...
INSERT INTO infomaquina(codigo,nome) values 
  ...
  (5,'CPU MPI 25%'),(6,'Root Work Path'),(7,'% CPU Ociosa'),(8,'JAVA_HOME'),(9,'MOPAC_HOME');
...
INSERT INTO maquina_infomaquina(maquina_codigo,infomaquina_codigo,valor) values
  ...
  (3,1,'192.168.0.104'),(3,2,'farmacia'),(3,3,'labsala18'),(3,4,'12'),(3,5,'6'),(3,6,'/home/farmacia/Documentos/Guilherme/'),(3,7,'40'),(3,8,'/usr/'),(3,9,'/usr/local/mopac');
...
INSERT INTO maquina_infomaquina(maquina_codigo,infomaquina_codigo,valor) values
  (1,1,'127.0.0.1'),(1,2,'tuy'),(1,3,'senha'),(1,4,'8'),(1,5,'2'),(1,6,'/home/tuy/Desktop/Guilherme/Farmacia/LaPFarSC/'),(1,7,'30'),(1,8,'/usr/lib/jvm/java-17-openjdk-amd64/'),(1,9,'/home/tuy/Documents/mopac/');
